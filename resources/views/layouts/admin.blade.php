...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link href="{{ asset('/assets/admin/css/css/custom.css') }}" rel="stylesheet">
        ...
        <div class=" border-bottom">
            ...
            <div class="drop-men" >
                <ul class=" nav_1">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret">Rackham<i class="caret"></i></span><img src="{{ asset('/assets/admin/images/wo.jpg') }}"></a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.article.index') }}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Articles</span> </a>
                        </li>
                        <li>
                            <a href="{{ route('country.index') }}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Countries</span> </a>
                        </li>
                        <li>
                            <a href="{{ route('category.index') }}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Categories</span> </a>
                        </li>
                        <li>
                            <a href="{{ route('product.index') }}" class=" hvr-bounce-to-right"><i class="fa fa-inbox nav_icon"></i> <span class="nav-label">Products</span> </a>
                        </li>
